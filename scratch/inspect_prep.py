...
prep_path = os.path.join(project_root, "outputs", "checkpoints", "preprocessors.pkl")
...
# Let's check the scaler to see how many features it was fittted on
if hasattr(clin.num_scaler, "n_features_in_"):
    print(f"Scaler expects {clin.num_scaler.n_features_in_} features")
