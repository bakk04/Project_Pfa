...
# ===========================================================================
# 2. CHEMINS GOOGLE DRIVE (Persistance des poids et artefacts)
# ===========================================================================
# Sur Google Colab, exécutez d'abord :
#   from google.colab import drive
#   drive.mount('/content/drive')

DRIVE_ROOT = "/content/drive/MyDrive/DiabetesMultimodal" if IS_COLAB else "./outputs"

@dataclass
class PathConfig:
    """Tous les chemins du projet."""
    # Racine persistante (Google Drive ou local)
    root: str = DRIVE_ROOT
...
class ClinicalConfig:
    ...
    input_dim: int = 47        # Nombre de features NHANES après preprocessing
...
class TrainConfig:
    ...
    epochs: int = 100
    batch_size: int = 64
    num_workers: int = 2       # Adapter selon le CPU Colab (2-4)
...
NUMERICAL_FEATURES = [
    ...
    "waist_hip_ratio", "weight_kg", "height_cm",
    "systolic_bp", "diastolic_bp", "pulse_rate",
    "glucose_fasting_mg_dl", "hba1c_pct",
    "total_cholesterol", "hdl_cholesterol", "ldl_cholesterol",
    "triglycerides", "creatinine_mg_dl", "uric_acid",
    "albumin_g_dl", "alkaline_phosphatase",
    "physical_activity_mets",   # Equivalent métabolique
    "sleep_hours",
    "caloric_intake_kcal",
]
...
CATEGORICAL_FEATURES = [
    "sex",                 # 0: Female, 1: Male
    "race_ethnicity",      # 1-5 (NHANES codes)
    "education_level",     # 1-5
    "smoking_status",      # 0: Never, 1: Former, 2: Current
    "alcohol_consumption", # 0: None, 1: Moderate, 2: Heavy
    "family_history_diabetes",  # 0/1
    "hypertension_dx",     # 0/1
    "cardiovascular_dx",   # 0/1
    "physical_activity_level",  # 0: Sedentary, 1: Light, 2: Moderate, 3: Active
]
...
# Target
TARGET_COLUMN = "diabetes_label"  # 0: Non-diabétique, 1: Diabétique

# ===========================================================================
# 12. RÉSUMÉ DE CONFIGURATION (pour debug rapide)
# ===========================================================================
